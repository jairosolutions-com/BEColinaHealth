...
export class AppointmentsService {
  ...
  async getAllAppointmentsByPatient(patientId: number, page: number = 1, sortBy: string = 'appointmentStatus', sortOrder: 'ASC' | 'DESC' = 'ASC', perPage: number = 5): Promise<{ data: Appointments[], totalPages: number, currentPage: number, totalCount }> {
